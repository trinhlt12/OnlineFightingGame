...
namespace Fusion.Menu
{
    ...
    public partial class FusionMenuConnectArgs : IFusionMenuConnectArgs
    {
        ...
        /// </summary>
        public virtual string Username { get => PlayerPrefs.GetString("Photon.Menu.Username"); set => PlayerPrefs.SetString("Photon.Menu.Username", value); }
        ...
        /// </summary>
        public virtual string PreferredRegion { get => PlayerPrefs.GetString("Photon.Menu.Region"); set => PlayerPrefs.SetString("Photon.Menu.Region", string.IsNullOrEmpty(value) ? value : value.ToLower()); }
        ...
        /// </summary>
        public virtual string AppVersion { get => PlayerPrefs.GetString("Photon.Menu.AppVersion"); set => PlayerPrefs.SetString("Photon.Menu.AppVersion", value); }

        /// <summary>
        /// The max player count that the user selected in the menu.
        /// </summary>
        public virtual int MaxPlayerCount { get => PlayerPrefs.GetInt("Photon.Menu.MaxPlayerCount"); set => PlayerPrefs.SetInt("Photon.Menu.MaxPlayerCount", value); }
...
namespace Fusion.Menu
{
    ...
    public partial class FusionMenuGraphicsSettings
    {
        ...
        /// </summary>
        public virtual bool Fullscreen { get => PlayerPrefs.GetInt("Photon.Menu.Fullscreen", Screen.fullScreen ? 1 : 0) == 1; set => PlayerPrefs.SetInt("Photon.Menu.Fullscreen", value ? 1 : 0); }

        /// <summary>
        /// Selected resolution index based on Screen.resolutions.
        /// Is not shown for mobile platforms.
        /// </summary>
        public virtual int Resolution { get => Math.Clamp(PlayerPrefs.GetInt("Photon.Menu.Resolution", GetCurrentResolutionIndex()), 0, Math.Max(0, Screen.resolutions.Length - 1)); set => PlayerPrefs.SetInt("Photon.Menu.Resolution", value); }

        /// <summary>
        /// Select VSync.
        /// </summary>
        public virtual bool VSync { get => PlayerPrefs.GetInt("Photon.Menu.VSync", Math.Clamp(QualitySettings.vSyncCount, 0, 1)) == 1; set => PlayerPrefs.SetInt("Photon.Menu.VSync", value ? 1 : 0); }
  ...
  Screen.currentResolution.refreshRate
        ...
        public virtual void Apply()
        {
            ...
            if (Screen.resolutions.Length > 0)
            {
                ...
                if (Screen.currentResolution.width != resolution.width || Screen.currentResolution.height != resolution.height || Screen.fullScreen != Fullscreen)
                {
...
namespace Fusion.Menu
{
    ...
    public class FusionMenuUIController<T> : FusionMonoBehaviour, IFusionMenuUIController where T : IFusionMenuConnectArgs, new()
    {
        ...
        protected FusionMenuConfig _config;

        /// <summary>
        /// The connection wrapper.
        /// </summary>
        [InlineHelp, SerializeField]
        protected FusionMenuConnectionBehaviour _connection;

        /// <summary>
        /// The list of screens. The first one is the default screen shown on start.
        /// </summary>
        [InlineHelp, SerializeField]
        protected FusionMenuUIScreen[] _screens;
...
namespace Fusion.Menu
{
    ...
    public abstract class FusionMenuUIScreen : FusionMonoBehaviour
    {
        ...
        /// </summary>
        [InlineHelp, SerializeField]
        private List<FusionMenuScreenPlugin> _plugins;
